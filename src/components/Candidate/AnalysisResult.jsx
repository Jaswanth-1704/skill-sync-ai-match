            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Progress value={animatedMatch} className={`h-3 rounded-full ${getProgressColor(analysis.matchPercentage)}`} />
                </div>
                ...
                <div>
                  ...
                  <Progress value={animatedATS} className={`h-3 rounded-full ${getProgressColor(analysis.atsFriendlinessScore)}`} />
                </div>
              </div>
            </div>
